...
public class GridGraphKitInspector : Editor
{
    ...
    private void OnSceneGUI()
    {
        ...
        if (mEditGridNode != null)
        {
            ...
            Handles.SphereHandleCap(3, (Vector3)mEditGridNode.position, Quaternion.identity, 0.3f, EventType.Repaint);
        }
        DrawNodeEventIcon();
        DrawSceneUI();
    }
    ...
    private void DrawNearestNode(Vector3 world)
    {
        ...
        Handles.SphereHandleCap(3, (Vector3)mNearsetNode.position, Quaternion.identity, 0.3f, EventType.Repaint);
    }
    ...
    private GridNode RaycastGrid(SceneView sceneView, GridGraph graph, bool debug)
    {
        ...
        if (Physics.Raycast(_ray, out _hit, float.MaxValue))
        {
            ...
            {
                Handles.RectangleHandleCap(0, _hit.point, Quaternion.Euler(90,0,0), mBrushSize, EventType.Repaint);
            }
